package com.crobox.reactiveconsul.client.dao.pekko

import com.crobox.reactiveconsul.client.dao._
...
class PekkoHttpConsulClient(host: URL)(implicit actorSystem: ActorSystem)
